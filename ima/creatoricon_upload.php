...
if(count($err_message) === 0){
    ...
    if(is_uploaded_file($tmp_path)){
        ...
        if(move_uploaded_file($tmp_path, $save_path)) {
            ...
            if($result){
                $sql2 = "UPDATE creator SET creator_iconname ='$save_filename' WHERE creator_name = '$creator_name'";
